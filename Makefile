...
graph :; surya graph src/contracts/**/*.sol | dot -Tpng > graph.png

describe :; surya describe src/contracts/**/*.sol

inherit :; surya inheritance src/contracts/**/*.sol | dot -Tpng > inheritance.png
